...
public class browserstack_signup {
	WebDriver driver;
	@FindBy(xpath = "(//h1)[1]")
	...
	public browserstack_signup(WebDriver driver) {
	this.driver = driver;
	...
	txt_FullName.clear();
	txt_FullName.sendKeys("Raziya sulthana");
	} else {
	...
	txt_BusinessEmail.sendKeys("raziyasulthana.mba@gmail.com");
	} else {
	...
	txt_password.clear();
	txt_password.sendKeys("raziyamd786");
	} else {
